...
causal_analysis_data_full <-
  zoo(cbind(business_demo_requests$IT,
            business_demo_requests$AT,
            business_demo_requests$CH,
            business_demo_requests$DE,
            business_demo_requests$FR,
            business_demo_requests$SE),
      time.points)
...
saveRDS(causal_impact_results_full,
        file = here("05.Output/models/causal_impact_model_demo_requests_full.Rds"))
saveRDS(causal_impact_results_partial,
        file = here("05.Output/models/causal_impact_model_demo_requests_partial.Rds"))